...
Study](https://ohdsi.github.io/Picard/dev/articles/launching_a_study.md)),
...
Control](https://ohdsi.github.io/Picard/dev/articles/launching_a_study.html#setting-up-git-version-control)
...
See [Loading
Inputs](https://ohdsi.github.io/Picard/dev/articles/loading_inputs.md)
for detailed guidance on importing from ATLAS and managing manifests.
...
Git. Picard provides
[`saveWork()`](https://ohdsi.github.io/Picard/dev/reference/saveWork.md)
to make Git commits easy for new users:
...
[`saveWork()`](https://ohdsi.github.io/Picard/dev/reference/saveWork.md)
is a convenience wrapper around Git operations that handles the common
workflow for you:
...
[`saveWork()`](https://ohdsi.github.io/Picard/dev/reference/saveWork.md)
or Git commands directly (see [Commit Changes with
...
the
Pipeline](https://ohdsi.github.io/Picard/dev/articles/running_the_pipeline.md)
