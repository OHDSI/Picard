...
complement, composite) with parsed dependency information sourced
directly from SQLite. Useful for quickly auditing what each derived
cohort depends on and how it was built.
...
### Method [`importAtlasCohorts()`](https://ohdsi.github.io/Picard/dev/reference/importAtlasCohorts.md)
...
#### Usage
    ...
    CohortManifest$addSqlCohort(filePath, label, category, tags = list())
...
### Method [`buildUnionCohort()`](https://ohdsi.github.io/Picard/dev/reference/buildUnionCohort.md)
...
- `cohortIds`:
  ...
  Integer vector. IDs of parent cohorts to union.
...
- `gapDays`:
  ...
  Integer. Maximum gap between eras to merge. Default 0.
...
### Method [`buildSubsetCohortTemporal()`](https://ohdsi.github.io/Picard/dev/reference/buildSubsetCohortTemporal.md)
...
- `filterCohortId`:
  ...
  Integer. ID of the filter cohort.
...
- `startWindow`:
  ...
  A SubsetWindowOperator object (from
  [`createSubsetStartWindow()`](https://ohdsi.github.io/Picard/dev/reference/createSubsetStartWindow.md))
  defining the temporal window for the filter cohort start date relative
  to the base cohort event.

- `endWindow`:

  A SubsetWindowOperator object (from
  [`createSubsetEndWindow()`](https://ohdsi.github.io/Picard/dev/reference/createSubsetEndWindow.md))
  or NULL. Defines the temporal window for the filter cohort end date.
  Default: NULL.
...
- `subsetLimit`:
  ...
  Character. One of 'First', 'Last', or 'All'. Default: 'First'.
...
### Method [`buildComplementCohort()`](https://ohdsi.github.io/Picard/dev/reference/buildComplementCohort.md)
...
### Method [`buildCompositeCohort()`](https://ohdsi.github.io/Picard/dev/reference/buildCompositeCohort.md)
...
- `cohortIds`:
  ...
  Integer vector. IDs of cohorts to intersect.
...
- `minCohorts`:
  ...
  Integer. Minimum cohorts a subject must appear in. Default: all.
...
### Method [`buildStratifiedCohorts()`](https://ohdsi.github.io/Picard/dev/reference/buildStratifiedCohorts.md)
