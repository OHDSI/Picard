...
```{r eval = FALSE}
cm <- initCohortManifest()
cm$setAtlasConnection(atlasConn)
cm$importAtlasCohorts(
...
# Initialize manifest and set connection
csm <- initConceptSetManifest()
csm$setAtlasConnection(atlasConn)
csm$importAtlasConceptSets(
...
# 2. Initialize manifest, set connection, and create load file
cm <- initCohortManifest()
cm$setAtlasConnection(atlasConn)
createBlankCohortsLoadFile(here::here("inputs/cohorts"))

# 3. Import from ATLAS (edit cohortsLoad.csv in Excel first)
cm$importAtlasCohorts(
  cohortsLoadPath = here::here("inputs/cohorts/cohortsLoad.csv")
)
...
# 1. Initialize manifest, set connection, and create load file
csm <- initConceptSetManifest()
csm$setAtlasConnection(atlasConn)
createBlankConceptSetsLoadFile(here::here("inputs/conceptSets"))

# 2. Import from ATLAS (edit conceptSetsLoad.csv in Excel first)
csm$importAtlasConceptSets(
  conceptSetsLoadPath = here::here("inputs/conceptSets/conceptSetsLoad.csv")
)
