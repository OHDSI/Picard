...
For Phase 1 derived builders, prefer passing manifest query rows (entries)
instead of raw IDs.
...
This is shown as a legacy compatibility example using ID inputs. Note a warning will appear encouraging the user to use entries instead of ids. 
