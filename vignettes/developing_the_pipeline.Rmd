...
**For Cohorts:** Edit cohort metadata files directly in your project:

```{r eval = FALSE}
file.edit(here::here("inputs/cohorts/load.csv"))
```

This opens the cohort manifest CSV so you can define study populations.
