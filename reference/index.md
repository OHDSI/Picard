...
- [`buildCompositeCohort()`](https://ohdsi.github.io/Picard/reference/buildCompositeCohort.md)
  : Build a Composite Cohort Definition
- [`buildStratifiedCohorts()`](https://ohdsi.github.io/Picard/reference/buildStratifiedCohorts.md)
...
- [`defineCustomCohort()`](https://ohdsi.github.io/Picard/reference/defineCustomCohort.md)
...
- [`testOrchestratePipelineExport()`](https://ohdsi.github.io/Picard/reference/testOrchestratePipelineExport.md)
...
- [`updateCohortMetadata()`](https://ohdsi.github.io/Picard/reference/updateCohortMetadata.md)
