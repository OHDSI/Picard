...
- [`updateCohortManifest()`](https://ohdsi.github.io/Picard/reference/updateCohortManifest.md)
  : Update the Label, Category, and/or Tags of an Existing Cohort
  Manifest
- [`updateConceptSetManifest()`](https://ohdsi.github.io/Picard/reference/updateConceptSetManifest.md)
